...
def plot_renewable_correlation_loc(grouped_loc_df, low_resource_high_demand):
    """
    Same as plot_renewable_correlation but separated into specific location clusters.
    Args:
        grouped_loc_df: timeseries dataframe of each clustered region separated into a multi index of [time, location]
        low_resource_high_demand: Periods defined by thresholds in analyze.renewable_correlation()
...
def plot_peak_time(data_list, label_list, color_list=None):
    """
    Plots the time of when peaks occur
    Args:
        grouped_loc_df: timeseries dataframe of each clustered region separated into a multi index of [time, location]
        low_resource_high_demand: Periods defined by thresholds in analyze.renewable_correlation()
        color_list: colors of plotted data
...
def plot_setpoints(grouped_df, day):
    """
